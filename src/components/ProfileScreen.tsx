      ...
      <section className="bg-white rounded-xl shadow-xs border border-slate-200/80 p-2 space-y-1">
        ...
        <div className="flex items-center justify-between p-3 border-b border-slate-100">
          ...
          <button
            ...
            className={`w-11 h-6 flex items-center rounded-full p-1 transition-colors ${darkMode ? 'bg-[#1e40af]' : 'bg-slate-200'
              }`}
          >
            <div
              className={`bg-white w-4 h-4 rounded-full shadow-md transform transition-transform ${darkMode ? 'translate-x-5' : 'translate-x-0'
                }`}
            />
          </button>
        </div>
